...
const short RED_MASK = 0x1f;
const short GREEN_MASK = 0x3f;
const short BLUE_MASK = 0x1f;

const short RED_SHIFT = 11;
const short GREEN_SHIFT = 5;
const int PIXEL_MASK = 0xff;

static const short MUL_TABLE[] = {512, 512, 456, 512, 328, 456, 335, 512, 405, 328, 271, 456, 388, 335, 292, 512,
