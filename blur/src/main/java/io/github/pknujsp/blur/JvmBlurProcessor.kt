...
class JvmBlurProcessor : Workers(), IBlur {
  ...
  private companion object {
    ...
    private val availableThreads by lazy { Runtime.getRuntime().availableProcessors() }

    @OptIn(DelicateCoroutinesApi::class) private val dispatchers by lazy { newFixedThreadPoolContext(availableThreads, "StackBlurThreads") }
  }
